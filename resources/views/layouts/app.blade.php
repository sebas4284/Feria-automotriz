...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="AutoFeria CRM">
...
<body class="bg-gray-950 text-white">
    ...
    @include('partials._push-banner')

    <div class="flex min-h-screen">

        @php
            $navItems = [
                ['href' => '/dashboard',                  'label' => 'Dashboard',      'match' => 'dashboard',      'roles' => ['admin', 'concesionario'],
                 'icon' => 'M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25'],
                ['href' => route('clientes.index'),       'label' => 'Clientes',       'match' => 'clientes*',      'roles' => ['admin', 'concesionario', 'staff'],
                ...
                ['href' => route('ventas.index'),         'label' => 'Ventas',         'match' => 'ventas*',        'roles' => ['admin', 'concesionario', 'aseguradora'],
                ...
                ['href' => route('rifa.index'),           'label' => 'Experiencia',    'match' => 'rifa*',          'roles' => ['admin', 'staff'],
            ...
            <header class="hidden lg:block bg-gray-900 border-b border-gray-800 px-6 py-4 sticky top-0 z-30">
                <div class="flex items-center justify-between gap-4">
                    <h2 class="text-lg font-bold truncate">
                        ...
                        @elseif(request()->is('rifa*'))           Experiencia
    ...
    <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800 z-50">
        <div class="flex">
            ...
            @if(in_array(Auth::user()->rol, ['admin', 'concesionario', 'staff']))
            ...
            @if(in_array(Auth::user()->rol, ['admin', 'concesionario', 'aseguradora']))
